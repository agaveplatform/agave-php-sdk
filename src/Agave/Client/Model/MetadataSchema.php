...
class MetadataSchema implements ModelInterface, ArrayAccess
{
     ...
     * Sets created
     *
     * @param \DateTime $created A timestamp indicating when this Metadata was created in the metadata schema store.
     *
     * @return $this
     */
     ...
     *
     * @param string $internal_username The name of the Internal User, if any, who owns this schema.
     *
     * @return $this
     */
     ...
     * Sets last_updated
     *
     * @param \DateTime $last_updated A timestamp indicating when this Metadata was last updated in the metadata schema store.
     *
     * @return $this
     */
     ...
     * Sets owner
     *
     * @param string $owner The API user who owns this Schema.
     *
     * @return $this
     */
     ...
     * Sets schema
     *
     * @param string $schema A JSON Schema
     *
     * @return $this
     */
     ...
     * Sets uuid
     *
     * @param string $uuid The UUID for this Schema.
     *
     * @return $this
     */
